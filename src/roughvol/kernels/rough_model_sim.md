...
A simple method to model stock dynamics is by
...
with singular kernel $g(x) \sim x^\alpha L_g(x)$, for nonzero $\alpha$ between $-\frac{1}{2}$ and $\frac{1}{2}$, approximate the kernel by
